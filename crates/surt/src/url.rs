...
/// [`Canonicalizer::HERITRIX`] disables the optional rules while retaining the common normalization
/// below. Rules can also be combined from a preset: `Canonicalizer { strip_www: false,
...
/// - renders numeric IPv4 hosts as dotted quads and non-ASCII host labels with Punycode.
#[expect(
