...
mod tests {
    ...
    fn arbitrary_maps_round_trip(
        #[strategy = prop::extra_properties()] properties: ExtraProperties,
    ) {
    ...
    #[proptest::property_test]
    fn serde_round_trips(#[strategy = prop::extra_properties()] properties: ExtraProperties) {
    ...
    #[proptest::property_test]
    fn inserted_reserved_names_are_rejected(#[strategy = prop::bare_text()] name: String) {
        let mut properties = ExtraProperties::default();
